...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'proso_questions_decoratedanswer_ab_values')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('decoratedanswer', models.ForeignKey(orm[u'proso_questions.decoratedanswer'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'proso_questions_decoratedanswer_ab_values'))
