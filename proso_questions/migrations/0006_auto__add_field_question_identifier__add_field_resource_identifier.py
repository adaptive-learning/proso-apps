...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'proso_questions_question', 'identifier',
                      self.gf('django.db.models.fields.SlugField')(default=None, max_length=50, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Resource.identifier'
        db.add_column(u'proso_questions_resource', 'identifier',
                      self.gf('django.db.models.fields.SlugField')(default=None, max_length=50, unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'proso_questions_question', 'identifier')

        # Deleting field 'Resource.identifier'
        db.delete_column(u'proso_questions_resource', 'identifier')
