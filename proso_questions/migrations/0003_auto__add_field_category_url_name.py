...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'proso_questions.category': {
            ...
            'url_name': ('django.db.models.fields.SlugField', [], {'unique': 'False', 'max_length': '50'})
        },
