...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Category', fields ['url_name']
        db.create_unique(u'proso_questions_category', ['url_name'])

    def backwards(self, orm):
        # Removing unique constraint on 'Category', fields ['url_name']
        db.delete_unique(u'proso_questions_category', ['url_name'])
