...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.session'
        db.add_column(u'proso_models_answer', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['proso_user.Session'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Answer.session'
        db.delete_column(u'proso_models_answer', 'session_id')
