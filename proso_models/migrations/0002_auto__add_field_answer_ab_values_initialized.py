...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.ab_values_initialized'
        db.add_column(u'proso_models_answer', 'ab_values_initialized',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field ab_values on 'Answer'
        m2m_table_name = db.shorten_name(u'proso_models_answer_ab_values')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('answer', models.ForeignKey(orm['proso_models.answer'], null=False)),
            ('value', models.ForeignKey(orm['proso_ab.value'], null=False))
        ))
        db.create_unique(m2m_table_name, ['answer_id', 'value_id'])


    def backwards(self, orm):
        # Deleting field 'Answer.ab_values_initialized'
        db.delete_column(u'proso_models_answer', 'ab_values_initialized')

        # Removing M2M table for field ab_values on 'Answer'
        db.delete_table(db.shorten_name(u'proso_models_answer_ab_values'))
