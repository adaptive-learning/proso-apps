...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.ip_address'
        db.add_column(u'proso_models_answer', 'ip_address',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=39, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Answer.ip_address'
        db.delete_column(u'proso_models_answer', 'ip_address')
