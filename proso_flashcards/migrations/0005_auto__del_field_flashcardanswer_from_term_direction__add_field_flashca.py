...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FlashcardAnswer.from_term_direction'
        db.delete_column(u'proso_flashcards_flashcardanswer', 'from_term_direction')

        # Adding field 'FlashcardAnswer.direction'
        db.add_column(u'proso_flashcards_flashcardanswer', 'direction',
                      self.gf('django.db.models.fields.CharField')(default='t2d', max_length=3),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FlashcardAnswer.from_term_direction'
        raise RuntimeError("Cannot reverse this migration. 'FlashcardAnswer.from_term_direction' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'FlashcardAnswer.from_term_direction'
        db.add_column(u'proso_flashcards_flashcardanswer', 'from_term_direction',
                      self.gf('django.db.models.fields.BooleanField')(),
                      keep_default=False)

        # Deleting field 'FlashcardAnswer.direction'
        db.delete_column(u'proso_flashcards_flashcardanswer', 'direction')
