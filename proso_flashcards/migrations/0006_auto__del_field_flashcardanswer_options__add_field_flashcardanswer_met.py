...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FlashcardAnswer.options'
        db.delete_column(u'proso_flashcards_flashcardanswer', 'options')

        # Adding field 'FlashcardAnswer.meta'
        db.add_column(u'proso_flashcards_flashcardanswer', 'meta',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field options on 'FlashcardAnswer'
        m2m_table_name = db.shorten_name(u'proso_flashcards_flashcardanswer_options')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('flashcardanswer', models.ForeignKey(orm[u'proso_flashcards.flashcardanswer'], null=False)),
            ('term', models.ForeignKey(orm[u'proso_flashcards.term'], null=False))
        ))
        db.create_unique(m2m_table_name, ['flashcardanswer_id', 'term_id'])


    def backwards(self, orm):
        # Adding field 'FlashcardAnswer.options'
        db.add_column(u'proso_flashcards_flashcardanswer', 'options',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Deleting field 'FlashcardAnswer.meta'
        db.delete_column(u'proso_flashcards_flashcardanswer', 'meta')

        # Removing M2M table for field options on 'FlashcardAnswer'
        db.delete_table(db.shorten_name(u'proso_flashcards_flashcardanswer_options'))
    ...
    models = {
        ...
        u'proso_flashcards.category': {
            ...
            'subcategories': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'parents'", 'symmetrical': 'False', 'to': u"orm['proso_flashcards.Category']"}),
        ...
        u'proso_flashcards.flashcardanswer': {
            ...
            'options': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'answers_with_this_as_option'", 'symmetrical': 'False', 'to': u"orm['proso_flashcards.Term']"})
        },
