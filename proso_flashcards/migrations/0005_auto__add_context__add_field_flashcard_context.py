...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.context'
        db.add_column(u'proso_flashcards_category', 'context',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['proso_flashcards.Context'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Flashcard.context'
        db.add_column(u'proso_flashcards_flashcard', 'context',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['proso_flashcards.Context'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Category.context'
        db.delete_column(u'proso_flashcards_category', 'context_id')

        # Deleting field 'Flashcard.context'
        db.delete_column(u'proso_flashcards_flashcard', 'context_id')
