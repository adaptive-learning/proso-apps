...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Category.type'
        db.alter_column(u'proso_flashcards_category', 'type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Category.type'
        raise RuntimeError("Cannot reverse this migration. 'Category.type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Category.type'
        db.alter_column(u'proso_flashcards_category', 'type', self.gf('django.db.models.fields.CharField')(max_length=50))
